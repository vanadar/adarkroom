(function(){
	...
	var keywords = [ _('saved.'), _('wood'),_('builder'),_('teeth'),_('meat'),_('fur'), _('alien alloy'), _('bullets'),
	                 ...
	                 _('steelworker'),_('bait'),_('cured meat'), _('scales'), _('compass'), _('laser rifle'), _('bayonet'),
	                 ...
	                 _('not enough scales'),  _('not enough teeth'), _('not enough leather'), _('not enough cloth'),
